...
############ Go to the Tube Test (noisy version) ############
print('Press "c" to fly to the Tube Test (noisy version)')
while True:
...
############ Perform Tube Test (noisy version) ############
print('Press "c" to start the Tube Test (noisy version)')
while True:
    if keyboard.is_pressed('c'):
        break
time.sleep(0.5)
print('Performing Tube Test (noisy version)...')
