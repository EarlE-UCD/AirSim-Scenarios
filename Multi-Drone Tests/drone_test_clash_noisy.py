...
############ Go to the Clash Test (noisy version) ############
print('Press "c" to fly to the Clash Test (noisy version)')
while True:
...
takeoff3_2 = client.moveToPositionAsync(-47.41, -97.19, 0, 6, vehicle_name="Drone2")
takeoff3_1.join()
takeoff3_2.join()
...
############ Perform Clash Test (noisy version) ############
print('Press "c" to start the Clash Test (noisy version)')
while True:
    if keyboard.is_pressed('c'):
        break
time.sleep(0.5)
print('Performing Clash Test (noisy version)...')
